/**
 * SQLite database access layer for the AP (Autoriteit Persoonsgegevens) MCP server.
 *
 * Schema:
 *   - decisions    — AP decisions, sanctions (boetes), and recommendations
 *   - guidelines   — AP guidance documents, handleidingen, and normuitleg
